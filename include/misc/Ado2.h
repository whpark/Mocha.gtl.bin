#ifndef __ADO2_H__SEONGHYEONG_LEE__
#define __ADO2_H__SEONGHYEONG_LEE__

#if _MSC_VER >= _MSC_VER_VS4
#pragma once
#endif 
...
// C:\Program Files\System\ado\msado15.dll
#import <Common Files\System\ado\msado15.dll> rename("EOF", "EndOfFile")

#if 0	// 2012.07.12. Windows Update이후 아래 라인 컴파일 안됨.
// C:\Program Files\System\ado\MSJRO.DLL
#import <Common Files\System\ado\MSJRO.DLL> no_namespace
#endif
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 2007.02.05.		START	Commnet By		SeongHyeong, Lee
//class AFX_EXT_CLASS_MISC CJetEngine {
//public:
//						CJetEngine()	{ ; }
//	virtual				~CJetEngine()	{ ; }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
class AFX_EXT_CLASS_MISC CADODatabase
{
public:
	...
	void			SetConnectionTimeout(long nConnectionTimeout = 3) { m_nConnectionTimeout = nConnectionTimeout; };
protected:
...
///////////////////////////////////////////////////////////////////////////////////////////////////
class AFX_EXT_CLASS_MISC CADORecordset
{
public:
	...
	BOOL GetFieldValue(LPCTSTR lpFieldName, short& sValue);
	...
	BOOL GetFieldValue(LPCTSTR lpFieldName, LPTSTR lpszValue);
...
class AFX_EXT_CLASS_MISC CADOParameter
{
public:
	...
	void SetPrecision(BYTE nPrecision)
		{m_pParameter->PutPrecision(nPrecision);};
	void SetScale(BYTE nScale)
...
class AFX_EXT_CLASS_MISC CADOCommand
{
public:
	...
	BOOL AddParameter(CString strName, int nType, int nDirection, long lSize, double dblValue, BYTE nPrecision = 0, BYTE nScale = 0);
	...
	BOOL AddParameter(CString strName, int nType, int nDirection, long lSize, _variant_t vtValue, BYTE nPrecision = 0, BYTE nScale = 0);
	CString GetText()
...
class AFX_EXT_CLASS_MISC CADOException : public CException
{
public:
	enum {
		noError,	// no error
...
BOOL AFX_EXT_CLASS_MISC		DBConnection(CADODatabase* pdb = NULL, CString strCommand =_T(""), CString strDatabase =_T(""), CString strId =_T(""), CString strPassword =_T(""), int iTimeout=5);
