...
class AFX_EXT_CLASS_SCANNER CScannerRTC4 : public IScanner {
public:
	CScannerRTC4(int iBoard = 1);
	virtual ~CScannerRTC4();

	virtual eSCANNER_TYPE GetScannerType() { return SCANNER_RTC4; }
