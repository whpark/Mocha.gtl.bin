...
class AFX_EXT_CLASS_SCANNER CScannerRTC5 : public IScanner {
public:
	CScannerRTC5(int iBoard = 1);
	virtual ~CScannerRTC5();

	virtual eSCANNER_TYPE GetScannerType() { return SCANNER_RTC5; }
