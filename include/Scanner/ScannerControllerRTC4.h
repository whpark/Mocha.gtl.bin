...
class CScannerControllerRTC4 : public CScannerController {
private:
	volatile static long s_nRTC4Loaded;
public:
	CString m_str1to1CalibrationPath;

public:
	CScannerControllerRTC4(void);
	virtual ~CScannerControllerRTC4(void);
...
protected:
	...
	virtual void PolyLine(const TLineD& pts, const TList<double>& dBulges, BOOL bLoop);
